...
if(
    $sql &&
    $sql->bind_param("iisiiiiis",$uid,$time,$_POST["diff"],$gameObj->timeTaken,$gameObj->obstaclesHit,$gameObj->score,$gameObj->hintsUsed,$gameObj->passcodeAttempts,$_POST["obj"]) &&
    $sql->execute()
) {
