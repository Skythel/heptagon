...
function setDifficulty(level) {
    if (level == "hard") {
        ...
        var cdTimer = levels.hard.countdownTimer;
    } else if (level == "med") {
        ...
        var cdTimer = levels.med.countdownTimer;
    } else { // Default easy
        ...
        var cdTimer = levels.easy.countdownTimer;
    }

    // Create the object
    let thisGame = new game(cols, rows, puzzleIcons, puzzleChoices, cdTimer);
